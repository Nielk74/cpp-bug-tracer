---
description: Single-agent C++ bug tracer (baseline benchmark) — one agent reads files directly with no orchestration. Used to compare against the multi-agent cpp-bug-tracer workflow.
mode: primary
